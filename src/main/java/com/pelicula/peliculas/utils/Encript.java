package com.pelicula.peliculas.utils;
...
public class Encript {
    ...
    /*INSERT INTO public.usuario(
            id_usuario, nombre, usuario, password, fecha_alta, fecha_baja, fecha_actualizacion, status)
    VALUES (7, 'usuario', 'user', pgp_sym_encrypt('data', '7381@3', 'compress-algo=1, cipher-algo=aes128'), null,null, null, true);*/
    /**
